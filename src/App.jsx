      ...
      <main className="w-full max-w-3xl rounded-3xl p-4 sm:p-6 md:p-8 shadow-2xl border border-white/10 backdrop-blur-md bg-offwhite">
        ...
        <section className="mb-6">
          ...
          <p className="mb-2 text-primary">
            Welcome to Juniors.Dev, a creative community and collaboration hub built to give junior
            developers <span className="font-bold text-primary">real-world experience</span> through
        ...
        <section className="mb-6">
          ...
          <ul className="list-disc list-inside pl-4 mb-2 text-primary space-y-1 md:space-y-2">
            ...
            <li>
              Receive <b>coaching</b> and <b>mentorship</b> from more experienced devs and designers
              as you contribute
            </li>
            <li>
        ...
        <section className="mb-6">
          ...
          />
          <p className="mb-2 text-primary">
            <b>Productivity Graveyard</b>: As developers, we've all started countless projects that
            seemed exciting at first, only to abandon them for the next shiny idea.{" "}
